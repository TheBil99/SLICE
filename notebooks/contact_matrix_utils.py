...
def plot_genomewide_averages(mat, vmin , vmax , x_figsize= 15, y_figsize= 15, percent=True, colormap='RdYlBu_r', title = None):
    ...
    ax.set_xticklabels(['chr1', 'chr2', 'chr3', 'chr4', 'chr5', 'chr', 'chr7', 'chr8', 'chr9', 'chr10', 'chr11', 'chr12', 'chr13', 'chr14', 'chr15', 'chr16', 'chr17', 'chr18', 'chr19'], fontsize = 14);
    ax.set_yticklabels(['chr1', 'chr2', 'chr3', 'chr4', 'chr5', 'chr', 'chr7', 'chr8', 'chr9', 'chr10', 'chr11', 'chr12', 'chr13', 'chr14', 'chr15', 'chr16', 'chr17', 'chr18', 'chr19'], fontsize = 14);
...
def draw_square(X, Y, resolution, ax, x_annotation,y_annotation, linewidth = 1, edgecolor = 'b', x_s = 0, y_s = 0):
    ...
    rect = patches.Rectangle((x_inf, y_inf), x_sup - x_inf, y_sup - y_inf, linewidth=linewidth, edgecolor=edgecolor, facecolor='none')
    ax.add_patch(rect)
